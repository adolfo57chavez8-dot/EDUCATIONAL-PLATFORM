...
function renderAdminShell(profile, activeKey) {
  ...
  document.getElementById("app-shell").innerHTML = `
    ...
    <div class="main-area">
      <header class="topbar">
        <button id="admin-menu-toggle" class="admin-menu-btn" aria-label="Abrir menú">☰</button>
        <h2 class="admin-topbar-title">Panel administrativo</h2>
      </header>
  ...
  // Menú móvil: el sidebar se oculta en pantallas chicas (ver responsive.css),
  // así que en móvil se abre como panel deslizante con este botón.
  ...
  const closeSidebar = () => { sidebarEl.classList.remove("mobile-open"); backdropEl.classList.remove("visible"); };
